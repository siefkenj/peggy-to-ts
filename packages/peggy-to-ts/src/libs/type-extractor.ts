...
const TYPE_OFFSET = `type PeggyOffset = { offset: number; line: number; column: number };`;
const TYPE_LOCATION = `type PeggyLocation = { source: string | undefined; start: PeggyOffset; end: PeggyOffset };`;
...
// Types accessible by Peggy grammars (these may or may not be referenced in this grammar)
${TYPE_OFFSET}
${TYPE_LOCATION}

// The autogenerated types are below
`;
...
declare function location(): PeggyLocation;
declare function offset(): PeggyOffset;
